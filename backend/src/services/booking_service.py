...
def pricing_to_response(p: PricingConfig) -> PricingConfigResponse:
    return PricingConfigResponse(
        ...
        timeslot_daily_price=str(p.timeslot_daily_price),
        timeslot_weekly_price=str(p.timeslot_weekly_price),
        timeslot_monthly_price=str(p.timeslot_monthly_price),
        anytime_daily_price=str(p.anytime_daily_price),
        anytime_weekly_price=str(p.anytime_weekly_price),
        anytime_monthly_price=str(p.anytime_monthly_price),
