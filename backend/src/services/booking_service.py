...
def pricing_to_response(p: PricingConfig) -> PricingConfigResponse:
    return PricingConfigResponse(
        ...
        timeslot_daily_price=int(p.timeslot_daily_price),
        timeslot_weekly_price=int(p.timeslot_weekly_price),
        timeslot_monthly_price=int(p.timeslot_monthly_price),
        anytime_daily_price=int(p.anytime_daily_price),
        anytime_weekly_price=int(p.anytime_weekly_price),
        anytime_monthly_price=int(p.anytime_monthly_price),
        locker_daily_price=int(p.locker_daily_price),
        locker_weekly_price=int(p.locker_weekly_price),
        locker_monthly_price=int(p.locker_monthly_price),
